...
{
    [Export(typeof(ISampleDataProvider<AccoBookingEntities>))]
    public class AccoBookingSampleDataProvider : ISampleDataProvider<AccoBookingEntities>
    {
      ...
      #region ISampleDataProvider<AccoBookingEntities> Members

      public void AddSampleData(AccoBookingEntities manager)
        {
        ...
        private void GenerateSampleData(AccoBookingEntities manager)
        {
