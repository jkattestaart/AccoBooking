...
namespace Security
{
    ...
    public class LoginManager : IEntityLoginManager
    {
      ...
      {
         var resource = new ResourceManager("Security.SecurityResource", Assembly.GetExecutingAssembly());
         ...
         if (credential == null)
          ...
          {
            throw new LoginException(LoginExceptionType.Other, resource.GetString("Security_Invalid", culture));
