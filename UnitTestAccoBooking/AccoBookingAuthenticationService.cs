...
namespace AccoBooking.Authentication
{
    [Export(typeof(IAuthenticationService))]
    [Export(typeof(IUserService))]
    [PartCreationPolicy(CreationPolicy.Shared)]
  public class AccoBookingAuthenticationService : AuthenticationService, IUserService
    {
#if FAKESTORE
        public AccoBookingAuthenticationService()
        {
