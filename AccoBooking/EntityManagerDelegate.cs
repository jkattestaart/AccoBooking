...
{
  public class EntityManagerDelegate : EntityManagerDelegate<AccoBookingEntities>
    {
      public override void OnEntityChanged(AccoBookingEntities source, EntityChangedEventArgs args)
        {
            EventFns.Publish(new EntityChangedMessage(args.Entity));
        }

        public override void OnSaving(AccoBookingEntities source, EntitySavingEventArgs args)
        {
        ...
        public override void OnSaved(AccoBookingEntities source, EntitySavedEventArgs args)
        {
