...
namespace AccoBooking.ViewModels.Booking
{
  ...
  public class BookingTrusteeSearchViewModel : BaseSearchViewModel<DomainModel.Booking, BookingListItem>
  {
    ...
    public BookingTrusteeSearchViewModel(IUnitOfWorkManager<IAccoBookingUnitOfWork> unitOfWorkManager)
