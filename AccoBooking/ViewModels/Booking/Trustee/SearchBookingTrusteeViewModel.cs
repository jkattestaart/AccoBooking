...
namespace AccoBooking.ViewModels.Booking
{
  ...
  public class SearchBookingTrusteeViewModel : BaseScreen<DomainModel.Booking>
  {
    private ShellViewModel _shellViewModel;

    [ImportingConstructor]
    public SearchBookingTrusteeViewModel(IUnitOfWorkManager<IAccoBookingUnitOfWork> unitOfWorkManager,
                                  BookingTrusteeManagementViewModel bookingManagement,
    ...
    public BookingTrusteeManagementViewModel SearchBookingMaster { get; set; }
