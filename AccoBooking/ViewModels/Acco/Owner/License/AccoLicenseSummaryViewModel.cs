...
namespace AccoBooking.ViewModels.Acco
{
  ...
  public class AccoLicenseSummaryViewModel : BaseScreen<AccoOwner>
  {
    [ImportingConstructor]
    public AccoLicenseSummaryViewModel(IUnitOfWorkManager<IAccoBookingUnitOfWork> unitOfWorkManager,
